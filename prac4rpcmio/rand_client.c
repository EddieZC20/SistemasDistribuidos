...
char *host; //Esta variable almacena la IP del servidor o el nombre del host
CLIENT *Conectar_servidor(){
	CLIENT *clnt;
	clnt = clnt_create(host, RAND_PROG, RAND_VERS, "udp");
	//Importante, esta funcion define el protocolo para comunicarse entre el cliente y servidor
	if(clnt == NULL){
...
double obtiene_siguiente_random(void){
	double *result_2; //Importante en esta variable se retorna el resultado del servidor
